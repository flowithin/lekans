...
#[export_name = "\x01peek"]
extern "sysv64" fn peek() -> SnakeValue {
...
#[export_name = "\x01pop"]
extern "sysv64" fn pop() -> SnakeValue {
    let v = peek();
    println!("popped");
...
#[export_name = "\x01read"]
extern "sysv64" fn read() -> SnakeValue {
    let mut buf = String::new();
    std::io::stdin().read_line(&mut buf).unwrap();
    parse_snake_basic_val(buf.trim())
}

#[export_name = "\x01big_fun_ten"]
extern "sysv64" fn big_fun_ten(
    x1: SnakeValue, x2: SnakeValue, x3: SnakeValue, x4: SnakeValue, x5: SnakeValue, x6: SnakeValue,
    x7: SnakeValue, x8: SnakeValue, x9: SnakeValue, x10: SnakeValue,
) -> SnakeValue {
    println!(
        "x1: {}\nx2: {}\nx3: {}\nx4: {}\nx5: {}\nx6: {}\nx7: {}\nx8: {}\nx9: {}\nx10: {}",
        sprint_snake_val(x1),
